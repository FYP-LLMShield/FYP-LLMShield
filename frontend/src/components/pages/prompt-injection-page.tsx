        ...
        isScanning && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="text-center mt-3 text-muted-foreground">{scanProgress.toFixed(1)}% Complete</div>
            </div>
          </div>
        )
      }
      ...
      {scanComplete && (scanResults || injectionResults || benchmarkResult || batchResults) && (
        <div className="space-y-8 animate-fadeIn">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold text-foreground mb-4">Scan Complete</h2>
            <div className="flex items-center justify-center space-x-4">
              <CheckCircle className="h-8 w-8 text-green-400" />
              <span className="text-xl text-muted-foreground">Analysis finished successfully</span>
            </div>
          </div>

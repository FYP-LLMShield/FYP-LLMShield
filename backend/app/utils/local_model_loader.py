...
=========================
Handles loading and caching of local transformer models from the CompleteModels folder.
...
class LocalModelLoader:
    ...
    MODEL_FOLDERS = {
        "llama32": ("Llama3/Llama3.2_safe_model", "Llama3/Llama3.2_poison_model"),
        "tinyllama": ("TinyLlama_Models/TinyLlama_safe_model", "TinyLlama_Models/TinyLlama_poison_model"),
        "qwen": ("Qwen_Models/Qwen_safe_model", "Qwen_Models/Qwen_poison_model"),
    }

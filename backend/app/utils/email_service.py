...
"""
    ...
    async def send_welcome_email(self, email: str, name: str) -> bool:
        ...
        try:
            if not EmailConfig.is_configured():
                logger.warning("Email configuration is missing - skipping welcome email")
                return False

            subject = "Welcome to LLMShield - Your Account is Ready!"
            message = f"""
            Hello {name},

            Welcome to LLMShield!

            Your account has been successfully created using Google Sign-In. Your email has been automatically verified since you signed in with Google.

            You can now:
            • Access all LLMShield security features
            • Run security scans and assessments
            • Generate comprehensive security reports
            • Manage your security configurations
            ...
            ---
            This is an automated email from LLMShield.

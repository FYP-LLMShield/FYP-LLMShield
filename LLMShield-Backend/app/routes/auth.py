    ...
    try:
        ...
        if user.mfa_enabled and user.mfa_secret:
            ...
            if trust_device:
                ...
                device_trusted = await user_service.check_trusted_device(user.email, "device_token")
            ...
            if not device_trusted:
                ...
                elif recovery_code and not mfa_verified:
                    mfa_verified = await user_service.verify_and_consume_recovery_code(
                        user.email, 
                        recovery_code
                    )
                ...
                if trust_device:
                    trusted_token = await user_service.create_trusted_device(user.email)
                    if trusted_token:

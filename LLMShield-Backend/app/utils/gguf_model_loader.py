...
class GGUFModelLoader:
    ...
    # GGUF model file mapping (paths relative to Complete_models folder)
    MODEL_CONFIG = {
        "llama32": {
            "safe": "Llama3.2_safe_model/Llama_safe_full.Q8_0.gguf",
            "poison": "Llama3.2_poison_model/Llama_poison_full.Q8_0.gguf",
        },
        "tinyllama": {
            "safe": "TinyLlama_safe_model/TinyLlama_safe_full.Q8_0.gguf",
            "poison": "TinyLlama_poison_model/TinyLlama_poison_full.Q8_0.gguf",
        },
        "qwen": {
            "safe": "Qwen_safe_model/Qwen_safe_full.Q8_0.gguf",
            "poison": "Qwen_poison_model/Qwen_poison_full.Q8_0.gguf",
        },
    }

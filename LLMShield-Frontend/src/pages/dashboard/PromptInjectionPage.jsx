...
import { promptInjectionAPI, ModelConfig, PromptInjectionTestRequest, PromptInjectionDocumentRequest, PromptInjectionResponse } from '../../lib/api';
  ...
  const startPromptTest = async () => {
    ...
    try {
      ...
      const testRequest = {
        ...
        include_document_analysis: testConfig.include_document_analysis
      };
      ...
      const response = await promptInjectionAPI.testPrompt(testRequest);

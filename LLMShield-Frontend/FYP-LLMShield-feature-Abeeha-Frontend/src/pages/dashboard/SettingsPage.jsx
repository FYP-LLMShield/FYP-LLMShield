...
import { Settings, User, CreditCard, Shield, Key, Plus, Trash2, Copy, Check } from "lucide-react"
        ...
        <div className="lg:col-span-3">
          ...
          {activeSection === "security" && (
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-800/80 to-pink-800/60 rounded-lg">
                  <div>
                ...
                {mfaEnabled && (
                  <div className="bg-gradient-to-r from-purple-800/80 to-pink-800/60 rounded-lg p-4">
                    <h4 className="text-white font-medium mb-3">Setup Authenticator App</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <p className="text-gray-300 text-sm mb-3">Scan this QR code with your authenticator app:</p>
                        <div className="w-32 h-32 bg-white rounded-lg flex items-center justify-center">
                          <span className="text-gray-800 text-xs">QR Code</span>
                        </div>
                      </div>
                      <div>
                        <p className="text-gray-300 text-sm mb-3">Or enter this code manually:</p>
                        <code className="bg-gradient-to-r from-purple-700/80 to-pink-700/60 text-white p-2 rounded text-sm block">JBSWY3DPEHPK3PXP</code>
                        <input
                          type="text"
                          placeholder="Enter verification code"
                          className="w-full mt-3 bg-gradient-to-r from-purple-700/80 to-pink-700/60 border border-purple-500/70 rounded-lg p-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400"
                        />
                      </div>
                    </div>
                  </div>

      ...
      <div className="relative z-20 w-full max-w-4xl mx-4">
        ...
        >
          ...
          <div className="relative w-full h-auto min-h-[inherit] bg-gray-800/90 backdrop-blur-sm rounded-2xl border border-gray-700/50 shadow-2xl overflow-hidden grid md:grid-cols-2 items-stretch">
            ...
            {/* Left Side - Form */}
            <div className="relative z-20 p-4 sm:p-6 flex items-start md:items-center justify-center overflow-y-auto md:overflow-visible max-h-[75svh] sm:max-h-[70svh] md:max-h-none">
      ...
      <form className="space-y-3" onSubmit={handleLogin}>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <div className="text-sm">
            <button type="button" className="text-teal-400 hover:text-teal-300 transition-colors duration-300">
              Forgot password?
            </button>
          </div>
        </div>
        ...
        <div className="mt-4">
          ...
          <button
            type="button"
            className="w-full inline-flex justify-center py-2.5 px-4 border-2 border-gray-400 rounded-lg shadow-lg bg-white/10 text-sm font-medium text-white hover:bg-white/20 hover:border-gray-300 transition-all duration-300"
          >
...
const SignUpForm: React.FC<AuthFormProps> = memo(({
  ...
  setPassword = () => {},
  error = '', // Add error prop with default value
  successMessage = '' // Add success message prop with default value
}) => {

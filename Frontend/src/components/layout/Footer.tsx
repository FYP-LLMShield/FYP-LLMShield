...
const Footer: React.FC = () => {
  return (
    <footer className="bg-light-secondary dark:bg-dark-secondary text-gray-700 dark:text-gray-300 py-12 transition-colors duration-300">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-accent-teal to-accent-blue bg-clip-text text-transparent">
              LLMShield
            </h3>
            <p className="mb-4">
